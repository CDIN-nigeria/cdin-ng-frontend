        ...
        <div className="flex flex-col md:flex-row md:justify-center md:items-center">
            <div className="max-w-sm rounded overflow-hidden shadow-lg m-4">
                <div className="px-6 py-4">
                    <p className='text-green-800 text-l font-bold'>Our</p>
                    <div className="font-bold text-l mb-2">Strategy</div>
                    ...
                    <button className="mt-4 md:mt-36 bg-white hover:bg-green-500 text-green-500 font-semibold hover:text-white py-2 px-4 border border-green-500 hover:border-transparent rounded">
                        Register
                    </button>
                </div>
            </div>
            <div className="max-w-sm rounded overflow-hidden shadow-lg m-4">
                <div className='flex justify-center items-center'>
                    <img
                        className="w-36 h-36 md:w-56 md:h-56 m-5 rounded-full"
                        src="images/platform.jpg"
                        alt="Card"
                    />
                </div>
                <div className="px-6 py-4">
                    <div className="font-bold text-l mb-2">Platform</div>
                    <p className="text-gray-700 text-base">
            ...
            <div className="max-w-sm rounded overflow-hidden shadow-lg m-4">
                ...
                <div className="px-6 py-4">
                    <div className="font-bold text-l mb-2">Collaboration</div>
                    <p className="text-gray-700 text-base">
                        Public and private sectors in Nigeria are interdependent, relying on one another for effective service delivery. Blockchain Industry Association of Nigeria (BIAN) will help bring together relevant stakeholders to collaborate on blockchain projects.
                    </p>
                </div>
            </div>
            <div className="max-w-sm rounded overflow-hidden shadow-lg m-4">
                ...
                <div className="px-6 py-4">
                    <div className="font-bold text-l mb-2">Research And Development</div>
                    <p className="text-gray-700 text-base">
